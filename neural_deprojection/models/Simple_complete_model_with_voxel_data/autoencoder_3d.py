...
class DiscreteVoxelsVAE(AbstractModule):
    ...
    def log_likelihood(self, voxels, mu, logb):
        ...
        Args:
            voxels: Tensor, assumes properties are of the form log(maximum(1e-5, properties))
    ...
    def _build(self, voxels, **kwargs) -> dict:
        """
        Args:
            voxels: Tensor
            **kwargs:
        ...
        """
        latent_logits = self.compute_logits(voxels) # [batch, H, W, D, num_embeddings]
        ...
        log_likelihood = self.log_likelihood(voxels, mu, logb) # [num_samples, batch]
